import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as i,o as l,c as o,e as a,a as e,b as s,d as r}from"./app-415740f4.js";const c={},u={href:"https://www.npmjs.com/package/webpack-bundle-analyzer",target:"_blank",rel:"noopener noreferrer"};function d(v,n){const p=i("ExternalLinkIcon");return l(),o("div",null,[n[3]||(n[3]=a(`<p>从本节开始，进入网络层面的性能优化世界。</p><p>从第一节的示意图中看出，从输入 URL 到显示页面这个过程中，涉及到网络层面的，有三个主要过程：</p><ul><li>DNS 解析</li><li>TCP 连接</li><li>HTTP 请求/响应</li></ul><p>对于 DNS 解析 和 TCP 连接 两个步骤，前端可以做的努力非常有限。相比之下，<strong>HTTP 连接</strong> 这一层面的优化才是网络优化的核心。因此我们开门见山，抓主要矛盾，直接从 HTTP 开始讲起。</p><p>HTTP 优化有两个大的方向：</p><ul><li>减少请求次数</li><li>减少单次请求所花费的时间</li></ul><p>这两个优化点直直地指向了日常开发中非常常见的操作——资源的压缩与合并。</p><p>没错，这就是我们每天用构建工具在做的事情。而时下最主流的构建工具无疑是 webpack，所以我们这节的主要任务就是围绕业界霸主 webpack 来做文章。</p><h2 id="webpack-的性能瓶颈" tabindex="-1"><a class="header-anchor" href="#webpack-的性能瓶颈" aria-hidden="true">#</a> webpack 的性能瓶颈</h2><p>webpack 的优化瓶颈，主要是两个方面：</p><ul><li>webpack 的构建过程太花时间</li><li>webpack 打包的结果体积太大</li></ul><h2 id="webpack-优化方案" tabindex="-1"><a class="header-anchor" href="#webpack-优化方案" aria-hidden="true">#</a> webpack 优化方案</h2><h3 id="构建过程提速策略" tabindex="-1"><a class="header-anchor" href="#构建过程提速策略" aria-hidden="true">#</a> 构建过程提速策略</h3><h4 id="不要让-loader-做太多事情——以-babel-loader-为例" tabindex="-1"><a class="header-anchor" href="#不要让-loader-做太多事情——以-babel-loader-为例" aria-hidden="true">#</a> 不要让 loader 做太多事情——以 babel-loader 为例</h4><p>babel-loader 无疑是强大的，但它也是慢的。</p><p>最常见的优化方式是，<u>用 include 或 exclude 来帮我们避免不必要的转译</u>，比如 webpack 官方在介绍 babel-loader 时给出的示例：</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token literal-property property">module</span><span class="token operator">:</span> <span class="token punctuation">{</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  <span class="token literal-property property">entry</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    ...
    <span class="token literal-property property">vendor</span><span class="token operator">:</span> <span class="token punctuation">[</span><span class="token string">&quot;prop-types&quot;</span><span class="token punctuation">,</span> <span class="token string">&quot;babel-polyfill&quot;</span><span class="token punctuation">,</span> <span class="token string">&quot;react&quot;</span><span class="token punctuation">,</span> <span class="token string">&quot;react-dom&quot;</span><span class="token punctuation">,</span> <span class="token string">&quot;react-router-dom&quot;</span><span class="token punctuation">]</span><span class="token punctuation">,</span>
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="构建结果体积压缩" tabindex="-1"><a class="header-anchor" href="#构建结果体积压缩" aria-hidden="true">#</a> 构建结果体积压缩</h3><h4 id="文件结构可视化-找出导致体积过大的原因" tabindex="-1"><a class="header-anchor" href="#文件结构可视化-找出导致体积过大的原因" aria-hidden="true">#</a> 文件结构可视化，找出导致体积过大的原因</h4>`,43)),e("p",null,[n[1]||(n[1]=s("这里为大家介绍一个非常好用的包组成可视化工具——",-1)),e("a",u,[n[0]||(n[0]=s("webpack-bundle-analyzer",-1)),r(p)]),n[2]||(n[2]=s("，配置方法和普通的 plugin 无异，它会以矩形树图的形式将包内各个模块的大小和依赖关系呈现出来 。",-1))]),n[4]||(n[4]=a(`<p>在使用时，我们只需要将其以插件的形式引入：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>const BundleAnalyzerPlugin = require(&#39;webpack-bundle-analyzer&#39;).BundleAnalyzerPlugin;
