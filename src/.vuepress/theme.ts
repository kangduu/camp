...
import type { RevealJsPlugin } from "@vuepress/plugin-revealjs";
...
const themeOptions = {
  hostname: "https://kangduu.github.io/camp/",
  ...
  repo: "https://github.com/kangduu/camp",
  ...
  blog: {
    ...
    medias: {
      ...
      GitHub: "https://github.com/kangduu/camp",
  ...
  markdown: {
    ...
    imgSize: true,
    include: true,
    math: { type: "katex" as const },
    mark: true,
    mermaid: true,
    playground: {
      presets: ["ts", "vue"] as NonNullable<
        NonNullable<ThemeOptions["markdown"]>["playground"]
      >["presets"],
    },
    // 幻灯片
    revealjs: {
      plugins: ["highlight", "math", "search", "notes", "zoom"] as RevealJsPlugin[],
    },
    stylize: [
      {
        matcher: "Recommended",
